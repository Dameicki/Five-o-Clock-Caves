...
public:
    ...
    // constructor
    AnimatedMesh(vector<AnimatedVertex> vertices, vector<unsigned int> indices, vector<Texture> textures)
    {
    ...
    // render the mesh
    void Draw(Shader& shader, bool needTexture)
    {
        if (needTexture == true) // jeœli shader potrzebuje informacji o teksturach
        {
...
private:
    ...
    void setupMesh()
    {
        ...
        glVertexAttribIPointer(3, 4, GL_INT, sizeof(AnimatedVertex), (void*)offsetof(AnimatedVertex, BoneID));
        // vertex weights
        glEnableVertexAttribArray(4);
        glVertexAttribPointer(4, 4, GL_FLOAT, GL_FALSE, sizeof(AnimatedVertex), (void*)offsetof(AnimatedVertex, Weight));
        //// vertex tangent
        //glEnableVertexAttribArray(5);
        //glVertexAttribPointer(5, 3, GL_FLOAT, GL_FALSE, sizeof(AnimatedVertex), (void*)offsetof(AnimatedVertex, Tangent));
        //// vertex bitangent
        //glEnableVertexAttribArray(6);
        //glVertexAttribPointer(6, 3, GL_FLOAT, GL_FALSE, sizeof(AnimatedVertex), (void*)offsetof(AnimatedVertex, Bitangent));
